...
urlpatterns = [
    ...
    path('<course_field>-<course_code>-<semester>-<year>/all/', views.all_unit, name='all_unit'),
    path('<course_field>-<course_code>-<semester>-<year>/unit_added/', views.add_unit, name='add_unit'),
